...
export const companySources: CompanySource[] = [
  { name:"字节跳动", short:"字节", logo:"https://jobs.bytedance.com/favicon.ico", level:"A", status:"官方公开职位接口", url:"https://jobs.bytedance.com/campus/position", note:"专用适配器同步校招、实习与社招的产品/运营岗位，并生成可核验的单岗位详情链接。" },
  { name:"阿里巴巴", short:"阿里", logo:"https://campus-talent.alibaba.com/favicon.ico", level:"A", status:"全部活跃批次自动发现", url:"https://campus-talent.alibaba.com/campus/position", note:"自动合并应届、日常/研究型实习与人才计划，保留业务归属和岗位原文。" },
  ...
  { name:"美团", short:"美团", logo:"https://zhaopin.meituan.com/favicon.ico", level:"A", status:"校招/实习/社招公开接口", url:"https://zhaopin.meituan.com/web/social", note:"使用官方职位检索接口完整翻页，并区分校招、实习与社招。" },
  { name:"快手", short:"快手", logo:"https://campus.kuaishou.cn/favicon.ico", level:"A", status:"校招与实习公开接口", url:"https://campus.kuaishou.cn/recruit/campus/e/", note:"按官方职位关键词和分页接口同步校招、实习岗位。" },
  ...
  { name:"携程", short:"携程", logo:"https://careers.ctrip.com/favicon.ico", level:"A", status:"集团职位公开接口", url:"https://careers.ctrip.com/campus", note:"合并校招、实习与社招公开职位，直接链接到 MJ 编码岗位详情。" },
  { name:"京东", short:"京东", logo:"https://campus.jd.com/favicon.ico", level:"A", status:"三类招聘项目公开接口", url:"https://campus.jd.com/", note:"同时同步应届、实习与人才计划并完整翻页。" },
  { name:"拼多多", short:"拼多多", logo:"https://careers.pinduoduo.com/favicon.ico", level:"A", status:"校招与实习公开接口", url:"https://careers.pinduoduo.com/campus", note:"合并毕业生与实习通道；官方未匿名开放社招列表时不会虚构。" },
  { name:"得物", short:"得物", logo:"https://campus.dewu.com/favicon.ico", level:"A", status:"得物校招官方接口", url:"https://campus.dewu.com/578078/position/list", note:"使用得物指定官网及其公开职位接口，输出单岗位详情链接。" },
  { name:"网易", short:"网易", logo:"https://hr.163.com/favicon.ico", level:"A", status:"集团校招/社招统一接口", url:"https://hr.163.com/job-list", note:"覆盖网易集团全部公开业务单元，不再只看网易互娱。" },
  { name:"Bilibili", short:"B站", logo:"https://jobs.bilibili.com/favicon.ico", level:"A", status:"匿名校验后公开接口", url:"https://jobs.bilibili.com/campus/positions", note:"按官方匿名 CSRF 流程同步校招、实习与社招，不需要用户登录。" },
  { name:"米哈游", short:"米哈游", logo:"https://jobs.mihoyo.com/favicon.ico", level:"A", status:"校招与社招公开接口", url:"https://jobs.mihoyo.com/", note:"从官方 ATS 同步职位列表与完整详情。" },
  { name:"小红书", short:"小红书", logo:"https://job.xiaohongshu.com/favicon.ico", level:"A", status:"校招/社招公开接口", url:"https://job.xiaohongshu.com/campus/position", note:"同时采集校招、Ace 顶尖实习生计划与社招，严格排除内容/新媒体运营。" },
